...
-(CVPixelBufferRef)applyDoublePixelBuffer:(CVPixelBufferRef)pixelBuffer  withSecond:(CVPixelBufferRef)spixelBuffer{
    self.filter.pixelBuffer = spixelBuffer;
    self.filter.sPiexlBuffer = pixelBuffer;
    CVPixelBufferRef outputPixelBuffer = self.filter.outputPixelBuffer;
    CVPixelBufferRetain(outputPixelBuffer);
    return outputPixelBuffer;
}
